...
# Author: Prasanna R.N (Upskill Campus Internship Project)
...
Developed by **Prasanna R.N** as part of the Upskill Campus Internship in
...
# -----------------------------------------------
st.write("---")
st.write("Developed by **Prasanna R.N** | [LinkedIn Profile](https://www.linkedin.com/in/visnuprasanna22)")
